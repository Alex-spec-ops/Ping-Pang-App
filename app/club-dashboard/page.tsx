    ...
    <>
      ...
      <section className="px-3 pb-4">
        ...
        <ul className="space-y-2">
          ...
          <ActionRow
            icon="🏆"
            title="3 inscriptions en attente — Open Printemps"
            hint="Valider ou refuser les paiements"
            href="/club-dashboard/tournaments"
          />
          <ActionRow
            icon="📩"
            title="2 demandes d'adhésion"
            hint="Marie L. · Tom B."
            href="/club-dashboard/members"
          />
          <ActionRow
            icon="📣"
            title="Annoncer la fermeture du 1er mai"
            hint="Dernière annonce il y a 4 jours"
            href="/club-dashboard/communication"
          />
        </ul>
      </section>

      {/* ── Aperçu agenda du jour ── */}
      <section className="px-3 pb-4">
        <h2
          className="mb-2 text-[10px] font-bold uppercase tracking-widest"
          style={{
        ...
        {todayBookings.length === 0 ? (
          ...
          <ul className="space-y-2">
            {todayBookings.map((b) => {
              ...
              const hh = date.toLocaleTimeString("fr-FR", {
                hour: "2-digit",
                minute: "2-digit",
              });
              return (
