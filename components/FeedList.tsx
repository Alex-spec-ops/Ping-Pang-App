  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ borderBottom: "1px solid #E5E7EB", background: "rgba(249,249,255,0.97)" }}
      >
        {FILTERS.map((f) => (
          <button
            key={f.id}
            ...
            className="flex-1 rounded-xl py-1 transition-colors"
            style={{
              ...
              whiteSpace: "nowrap",
              background: filter === f.id ? "#0A241E" : "#F9F9FF",
              color: filter === f.id ? "#fff" : "#616363",
        ...
        <button
          ...
          className="shrink-0 grid h-6 w-6 place-items-center rounded-xl text-xs transition-all disabled:opacity-50 ml-1"
          style={{
...
function LiveStrip() {
  ...
  return (
    <div style={{ borderBottom: "1px solid #E5E7EB", background: "#F9F9FF" }}>
      <div
      ...
      >
        <span
          ...
          style={{ background: "#BA1A1A", boxShadow: "0 0 0 3px #BA1A1A33", animation: "pulse 1.5s ease-in-out infinite" }}
        />
        <span style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#BA1A1A" }}>
          En Direct
        </span>
        <span style={{ fontSize: "11px", color: "#616363", marginLeft: "auto" }}>
        ...
        {live.map((c) => {
          ...
          return (
            <div
              ...
              style={{ width: 200, border: "1px solid #E5E7EB", background: "#fff", borderLeft: "3px solid #BA1A1A" }}
            >
              <div className="flex items-center justify-between gap-2">
                <div className="flex flex-col items-center gap-0.5" style={{ minWidth: 0 }}>
                  ...
                  <span className="truncate text-center" style={{ fontSize: "10px", fontWeight: 600, fontFamily: "var(--font-ui)", color: "#0A241E", maxWidth: 60 }}>
                    {creator?.username ?? "—"}
                  </span>
                </div>
                <span style={{ fontSize: "11px", fontWeight: 700, color: "#616363" }}>VS</span>
                <div className="flex flex-col items-center gap-0.5" style={{ minWidth: 0 }}>
              ...
              <div className="flex items-center gap-1 flex-wrap">
                <span
                  ...
                  style={{ fontSize: "9px", fontWeight: 700, fontFamily: "var(--font-ui)", letterSpacing: "0.06em", textTransform: "uppercase", background: c.mode === "ranked" ? "#0A241E" : "#F9F9FF", color: c.mode === "ranked" ? "#fff" : "#616363", border: c.mode === "ranked" ? "none" : "1px solid #E5E7EB" }}
                >
                  {modeLabel(c.mode)}
                </span>
                <span style={{ fontSize: "10px", color: "#616363", fontFamily: "var(--font-ui)" }}>{c.format}</span>
                {c.venue && <span style={{ fontSize: "10px", color: "#616363", fontFamily: "var(--font-ui)" }}>· 📍 {c.venue}</span>}
              </div>
            </div>
          );
        })}
...
function PendingCard({ challenge: c }: { challenge: PlayerChallenge }) {
  ...
  return (
    <div
      className="mx-4 mb-3 rounded-xl p-3 flex flex-col gap-2"
      style={{ border: "1px solid #E5E7EB", borderLeft: "3px solid #d97706", background: "#F9F9FF" }}
    >
      <div className="flex items-center gap-2">
        <span className="text-xl leading-none">{creator?.avatar ?? "🏓"}</span>
        <div className="flex flex-col" style={{ minWidth: 0 }}>
          <span style={{ fontSize: "13px", fontWeight: 600, fontFamily: "var(--font-ui)", color: "#0A241E" }}>
            {creator?.fullName ?? "Joueur"} te défie
          </span>
          <span style={{ fontSize: "11px", color: "#616363", fontFamily: "var(--font-ui)" }}>
      ...
      {c.message && (
        <p style={{ fontSize: "12px", color: "#0A241E", fontStyle: "italic", margin: 0, fontFamily: "var(--font-ui)" }}>
          "{c.message}"
        </p>
      )}

      {state === "accepted" ? (
        <div style={{ fontSize: "12px", fontWeight: 600, color: "#0A241E", fontFamily: "var(--font-ui)" }}>
        ...
        <div className="flex gap-2">
          <button
            ...
            style={{ fontFamily: "var(--font-ui)", border: "1px solid #E5E7EB", background: "#fff", color: "#616363" }}
          >
            Décliner
          </button>
          <button
            ...
            className="flex-1 rounded-xl py-1.5 text-xs font-semibold transition-colors"
            style={{ fontFamily: "var(--font-ui)", background: "#0A241E", color: "#fff", border: "none" }}
          >
            ✅ Accepter
          </button>
        </div>
...
function OpenCard({ challenge: c }: { challenge: PlayerChallenge }) {
  ...
  return (
    <div
      ...
      style={{ border: "1px solid #E5E7EB", borderLeft: "3px solid #0A241E", background: "#F9F9FF" }}
    >
      ...
      <div className="flex flex-col flex-1" style={{ minWidth: 0 }}>
        ...
        {c.message && (
          <span style={{ fontSize: "11px", color: "#616363", fontStyle: "italic", fontFamily: "var(--font-ui)" }}>"{c.message}"</span>
        )}
      </div>
      <button
        type="button"
        ...
        style={{
          fontFamily: "var(--font-ui)",
          background: joined ? "#F9F9FF" : "#0A241E",
          color: joined ? "#616363" : "#fff",
          border: joined ? "1px solid #E5E7EB" : "none",
...
function AllChallengesView() {
  ...
  const SectionTitle = ({ children }: { children: React.ReactNode }) => (
    <div
      ...
      style={{ fontFamily: "var(--font-ui)", fontSize: "11px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: "#0A241E" }}
    >
      {children}
    </div>
  );
          ...
          {active.map((c) => {
            ...
            return (
              <div
                key={c.id}
                className="mx-4 mb-3 rounded-xl p-3 flex flex-col gap-2"
                style={{ border: "1px solid #E5E7EB", borderLeft: "3px solid #BA1A1A", background: "#F9F9FF" }}
              >
                <div className="flex items-center gap-3">
                  <span className="text-2xl leading-none">{creator?.avatar ?? "🏓"}</span>
                  <span style={{ fontSize: "12px", fontWeight: 700, color: "#616363" }}>VS</span>
                  ...
                  <span
                    className="ml-auto shrink-0 rounded-full px-1.5 py-0.5"
                    style={{ fontSize: "9px", fontWeight: 700, fontFamily: "var(--font-ui)", letterSpacing: "0.06em", textTransform: "uppercase", background: "#BA1A1A", color: "#fff" }}
                  >
                    Live
                  </span>
                </div>
                {c.message && (
                  <p style={{ fontSize: "12px", color: "#0A241E", fontStyle: "italic", margin: 0, fontFamily: "var(--font-ui)" }}>"{c.message}"</p>
                )}
              </div>
            );
          })}
