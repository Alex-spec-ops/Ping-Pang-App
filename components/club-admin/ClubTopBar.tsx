...
export default function ClubTopBar({ title, subtitle, right, clubName, clubLogo }: Props) {
    ...
    >
      <div className="mx-auto flex max-w-md items-center gap-3 px-4 pt-3 pb-2">
        ...
        <Link
          ...
          className="rounded-xl px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider transition-opacity hover:opacity-80"
          style={{
